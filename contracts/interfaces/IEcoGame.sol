...
interface IEcoGame {
    ...
    function callCraft(uint256[] calldata _mPic, uint256[] calldata amounts, uint256 cap, uint256 total, uint256 attack) external view returns(string memory name, uint256[] memory stats, uint256 cat);
